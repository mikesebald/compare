...
plot.differents <- plot_ly(differents, x = system, y = counts, 
                           ...
                           type = "bar")
layout(plot.differents, barmode = "stack", legend = list(x = 1.0, y = 0.5))
```
...
## Which postal address attributes are different
...
plot.differents <- plot_ly(df_columns, x = attributes, y = occurences, 
                           ...
                           type = "bar")
layout(plot.differents, autosize = FALSE, height = 300, barmode = "stack")
```
